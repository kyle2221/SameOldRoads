    ...
    <div style={{ height: '100%', overflowY: 'auto', background: 'var(--bg)' }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 2, flex: 1 }}>
          <div style={{ fontSize: 12, color: 'rgba(255,210,140,0.75)', fontWeight: 700, marginBottom: 8, letterSpacing: 0.3 }}>
            {greetIcon} {greetText}, {firstName}
          </div>
          <h1 style={{ margin: '0 0 10px', fontSize: 32, fontWeight: 900, color: '#fff', lineHeight: 1.06, letterSpacing: -1 }}>
